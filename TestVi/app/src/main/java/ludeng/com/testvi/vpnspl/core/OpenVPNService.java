...
import static ludeng.com.testvi.vpnspl.core.VpnStatus.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
...
/*    PendingIntent getLogPendingIntent() {
 ...
 for(String str:argv){
  ...
  Log.i("ICABVIEW","nativeLibraryDirectory is "+nativeLibraryDirectory);
