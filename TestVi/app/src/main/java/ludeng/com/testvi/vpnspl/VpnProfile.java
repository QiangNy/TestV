...
package ludeng.com.testvi.vpnspl;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public int mAuthenticationType = TYPE_CERTIFICATES;//choose type
    public String mName ="frist";
    ...
    public boolean mUseDefaultRoute = false;
    ...
    public boolean mUseDefaultRoutev6 = false;
    ...
    public UUID mUuid;
    public boolean mAllowLocalLAN = true;
    ...
    public String mServerName = "192.168.101.201";
    ...
    public Intent getStartServiceIntent(Context context) {
        ...
        Intent intent = new Intent(context, ludeng.com.testvi.vpnspl.core.OpenVPNService.class);
