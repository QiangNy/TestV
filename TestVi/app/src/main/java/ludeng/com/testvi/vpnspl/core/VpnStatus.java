...
*/
    ...
    public static void logMessageOpenVPN(LogLevel level, int ovpnlevel, String message) {
        ...
        Log.i("ICABVIEW","print is "+ovpnlevel+"   " +message);
    }
